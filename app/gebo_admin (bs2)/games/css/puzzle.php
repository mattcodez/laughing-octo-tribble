...
<html lang="en">
    <head>
		...
		<link rel="stylesheet" type="text/css" href="../../../../css/vendor/codemirror/lib/codemirror.css" />
                ...
                <div class="navbar navbar-fixed-top">
                    <div class="navbar-inner">
                        <div class="container-fluid">
                            <a class="brand" href="../../dashboard.html"><i class="icon-home icon-white"></i> Coding Puzzle Admin</a>
...
#mouth {
	...
	height: 10px;
						...
						<div class="span6">
							<div class="row">
								<p>Your's</p>
								<iframe id="userRender" sandbox="allow-same-origin allow-top-navigation" seamless srcdoc="
									<html>
									<head>
										<style id=&quot;userStyles&quot; type=&quot;text/css&quot;></style>
									</head>
                                    ...
                                    <div class="accordion-group">
                                        <div class="accordion-heading">
                                            <a href="#collapseOne" data-parent="#side_accordion" data-toggle="collapse" class="accordion-toggle">
                                                <i class="icon-folder-close"></i> Games
                                            </a>
                                        </div>
                                        <div class="accordion-body collapse" id="collapseOne">
                                            <div class="accordion-inner">
                                                <ul class="nav nav-list">
                                                    <li><a href="../css/puzzle.html">CSS Puzzle</a></li>
                                                    <li><a href="javascript:void(0)">SQL Puzzle</a></li>
                                                    <li><a href="javascript:void(0)">Javascript Puzzle</a></li>
                                                    <li><a href="javascript:void(0)">PHP Puzzle</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-group">
                                        <div class="accordion-heading">
                                            <a href="#collapseLong" data-parent="#side_accordion" data-toggle="collapse" class="accordion-toggle">
                                                <i class="icon-leaf"></i> Donate now
                                            </a>
                                        </div>
                                        <div class="accordion-body collapse" id="collapseLong">
                                            <div class="accordion-inner">
                                                Some text to show sidebar scroll bar<br>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus rhoncus, orci ac fermentum imperdiet, purus sapien pharetra diam, at varius nibh tellus tristique sem.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-group">
                                    ...
                                    <div class="accordion-group">
                                        <div class="accordion-heading">
                                            <a href="#collapseThree" data-parent="#side_accordion" data-toggle="collapse" class="accordion-toggle">
                                                <i class="icon-user"></i> Feedback
                                            </a>
                                        </div>
                                        <div class="accordion-body collapse" id="collapseThree">
                                            <div class="accordion-inner">
                                                <ul class="nav nav-list">
                                                    <li><a href="javascript:void(0)">Submit idea</a></li>
